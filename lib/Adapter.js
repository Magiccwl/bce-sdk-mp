/**
 * This file was made by bigmeow. Ref: https://github.com/bigmeow/axios-miniprogram-adapter.
 *
 */
...
import { getRequest, transformError, transformResponse, transformConfig } from './utils'
...
export default function mpAdapter (config) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const requestMethod = (config.method && config.method.toUpperCase()) || 'GET'
